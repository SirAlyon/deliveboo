<template>
    <div v-if="!loading">
        <div class="container mt-4 restaurant_main border-bottom">
            <div class="row">
                <div
                    class="col col-xs-12 col-lg-8 p-3 mb-4 mb-lg-0 restaurant_info"
                >
                    <div class="title">
                ...
                <div
                    class="col-xs-12 col-lg-4 p-3 mb-4 mb-lg-0 restaurant_image"
                >
                    <img
                        class="image_fluid"
                        :src="
                                        ...
                                        >
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Do you want to empty your
                                                    cart? You'll be able to add
                                                    new products
                                                </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <a
                                        ...
                                        ><i
                                            class="fas fa-times-circle p-0 cursor"
                                        ></i
                                    ></a>
                                    <!-- /.btn btn-danger -->
                                </div>
