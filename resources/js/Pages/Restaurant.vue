    ...
    <div v-if="!loading">
        <div class="container mt-4 restaurant_main border-bottom">
            <div class="row d-flex justify-content-between">
                <div
                    class="col col-xs-12 col-lg-6 p-3 mb-4 mb-lg-0 restaurant_info"
                >
                    <div class="title">
                        <h6 class="bg-light ms-1">
          ...
          <div class="info">
            <div class="tipologie my-4 ">
              ...
              >
                ...
                <div
                    class="col-xs-12 col-lg-5 p-3 mb-4 mb-lg-0 restaurant_image"
                >
                    <img
                        class=""
                        :src="
                            '/img' + '/' + restaurant.restaurant_name + '.jpeg'
                        "
                        alt="restaurant.name"
                        v-if="restaurant.name === 'User'"
                    />
            ...
            <div class="container">
                <div class="menu mt-4">
                    ...
                    <p class="caption-menu">
                        Seleziona i piatti per scegliere la quantità e
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="row g-3 mt-1 mb-4 mb-lg-0">
                            ...
                            >
                                ...
                                <div
                                    class="my_plate_card d-flex flex-column justify-content-between"
                                    v-else
                                >
                ...
                <div class="my_plate_card d-flex flex-column justify-content-between " v-else>
                  <div class="card_content">
                    ...
                    >
                        <div class="shopping_cart p-3 mt-0 mt-lg-4">
                            ...
                            <div
                                ...
                                v-for="(
                                    purchased_product, index
                                ) in shopping_cart"
                                :key="purchased_product.id"
                            >
                                <div class="col-6">
                                    <span
                                        class="name text-capitalize fs-14 font-basket"
                                    >
                            ...
                            <div class="row total">
                                ...
                                <div class="col-6 text-end">
                                    <h5 class="total fs-5" v-if="total >= 0">
                                        {{ total }}€
                                    </h5>
                                </div>
                                <!-- /.col-6 -->
                    ...
                    <div class="col-4" v-else>
                        <div
                            class="empty_shopping_cart d-flex flex-column justify-content-center align-items-center"
                        >
                            <span class="basket">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
