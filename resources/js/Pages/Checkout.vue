                    ...
                    (event) => {
                        ...
                        inputs.forEach((input) => {
                            ...
                            if (
                                ...
                                let fileExtension = input.value
                                    .split(".")
                                    .pop();

                                let allowedExtensione = [
                                    "jpg",
                                    "png",
                                    "jpeg",
                                    "gif",
                                ...
                                if (
                                    !allowedExtensione.includes(fileExtension)
                                ) {
                                    console.log(
                                        "deleted",
                                        fileExtension === "jpg"
