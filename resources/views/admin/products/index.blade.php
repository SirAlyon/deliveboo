...
<div class="container">
    ...
    <table class="table table-striped table-inverse table-responsive table-hover align-middle">
        <thead class="thead-inverse table-primary table text-center">
            <tr>
                <th>ID</th>
                <th>Name</th>
                <th>Price</th>
            ...
            @forelse($products as $product)
                <tr class="{{ ($product->visibility == 1) ? "not-visible" : "" }}">
                    ...
                    <td class="d-flex flex-column">
                        ...
                        <a class="btn btn-secondary btn-sm text-white mb-1" href="{{route('admin.products.edit', $product->id)}}"> 
                    ...
                    <button type="button" class="btn btn-danger text-white btn-sm mb-1" data-bs-toggle="modal" data-bs-target="#delete-product-{{$product->id}}">
                     ...
                     <div class="modal-dialog" role="document">
                         <div class="modal-content">
                             <div class="modal-header">
                                 <h5 class="modal-title">Delete {{$product->id}}</h5>
                                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                             </div>
                             <div class="modal-body">
                                 Are you sure to delete this product?!  "<strong>{{$product->name}}</strong>"
                             </div>
            ...
            @empty
                <tr>
                    <td scope="row"> No Products yet!</td> 
                </tr>
            @endforelse
            </tbody>
    </table>
