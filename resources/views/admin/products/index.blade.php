            ...
            @forelse($products as $product)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-warning btn-sm text-white" href="{{route('admin.products.edit', $product->id)}}"> 
                    ...
                    <button type="button" class="btn btn-danger text-white btn-sm" data-bs-toggle="modal" data-bs-target="#delete-product-{{$product->id}}">
